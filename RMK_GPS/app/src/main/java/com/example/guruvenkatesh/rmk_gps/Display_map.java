...
public class Display_map extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double longtitude=Double.parseDouble(bundle.getString("longtitude"));
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(Display_map.this);
    }

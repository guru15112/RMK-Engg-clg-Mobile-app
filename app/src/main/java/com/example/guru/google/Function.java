...
public class Function {
    ...
    static final String KEY_GALLERY= "gallery";
    ...
    public static HashMap<String, String> mappingInbox(String album, String path,String count,String gallery)
    {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(KEY_ALBUM, album);
        map.put(KEY_PATH, path);
        map.put(KEY_COUNT, count);
        map.put(KEY_GALLERY, gallery);
        return map;
    }
    public static HashMap<String, String> outbox(String path)
    {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put(KEY_PATH, path);
        return map;

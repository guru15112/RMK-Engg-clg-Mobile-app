...
public class Hostel extends AppCompatActivity {
    ...
    private class callmethod extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Hostel.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = getString(R.string.app_url)+"hostel.json";
                ...
                try {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                try {
                                    TextView hostel_content = (TextView) findViewById(R.id.hostel_content);


                                    ImageView hostel_image=(ImageView) findViewById(R.id.hostel_image) ;
                                    Picasso.with(Hostel.this)
                                            .load(k.getString("imag_url"))
                                            .into(hostel_image);
                                    hostel_content.setText(Html.fromHtml(k.getString("para1")));

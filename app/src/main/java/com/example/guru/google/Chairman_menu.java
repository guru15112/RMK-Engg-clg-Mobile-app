...
public class Chairman_menu extends AppCompatActivity {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chairman_menu);
        ImageView chairman=(ImageView) findViewById(R.id.chairman) ;
        final TextView tv=(TextView)findViewById(R.id.chairman_content);

        tv.setText(Html.fromHtml(getString(R.string.chairman_content)));
        Picasso.with(this)
